                ...
                <View style={{ marginTop: 30, alignSelf: 'center' }}>
                    ...
                    >
                        <TouchableOpacity onPress={toggle2}>
                            <View style={{ width: 160, height: 50, backgroundColor: email ? currentTheme.white : 'transparent', alignItems: 'center', justifyContent: 'center', borderRadius: 25 }}>
                        ...
                        <TouchableOpacity onPress={toggle}>
                            <View style={{ width: 160, height: 50, backgroundColor: phone ? currentTheme.white : 'transparent', alignItems: 'center', justifyContent: 'center', borderRadius: 25 }}>
