        ...
        <SafeAreaView style={[styles.safeArea, { backgroundColor: currentTheme.background }]}>
            <View style={styles.container}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 20 }}>
                    ...
                    <Text style={{ color: currentTheme.primary, fontFamily: 'Poppins-Bold', fontSize: 18 }}>Drug Details</Text>
                    <TouchableOpacity>
                    ...
                    <View>
                        ...
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 20 }}>
                                ...
                                <View>
                                    <Text style={{ color: currentTheme.primary, fontFamily: 'Poppins-Bold', fontSize: 15, top: 2 }}>$ 15.00</Text>
                                </View>
                            </View>
                        ...
                        <View style={{ marginTop: 35 }}>
                            <View>
                                <Text style={{ color: currentTheme.primary, fontFamily: 'Poppins-Bold', fontSize: 16, }}>Description</Text>
